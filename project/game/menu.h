...
#define COLOR_SELECTED   0xFFD700   /* gold */
#define COLOR_UNSELECTED 0x444444   /* dark grey */
...
int  menu_mouse_hover(int x, int y);   /* returns which option mouse is over, -1 if none */
